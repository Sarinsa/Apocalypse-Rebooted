...
public class MonsterFishhookRenderer extends EntityRenderer<MonsterFishhook> {
    ...
    public void render( MonsterFishhook entity, float rotation, float partialTicks,
        ...
        double xRod, yRod, zRod;
        
        // Assume flying anglers don't have arms or rods
        if( angler instanceof FlyingMob ) {
            xRod = Mth.lerp( partialTicks, angler.xo, angler.getX() );
            yRod = Mth.lerp( partialTicks, angler.yo, angler.getY() ) + upwardOffset;
            zRod = Mth.lerp( partialTicks, angler.zo, angler.getZ() );
        }
        else {
            ...
            xRod = Mth.lerp( partialTicks, angler.xo, angler.getX() ) - forwardX * forwardOffset - forwardZ * rightwardOffset;
            yRod = Mth.lerp( partialTicks, angler.yo, angler.getY() ) + upwardOffset;
            zRod = Mth.lerp( partialTicks, angler.zo, angler.getZ() ) + forwardZ * forwardOffset - forwardX * rightwardOffset;
        }
