...
public class GhostModel<T extends GhostEntity> extends SegmentedModel<T> {
    ...
    public GhostModel() {
        this.head = new TransparentModelRenderer(this, 0, 0).addBox(-2.0F, -10.0F, -2.0F, 4, 10, 4);
        this.body = new TransparentModelRenderer(this, 16, 10).addBox(-4.0F, 0.0F, -2.0F, 8, 18, 4);
        this.rightArm = new TransparentModelRenderer(this, 0, 16).addBox(-3.0F, -2.0F, -2.0F, 4, 12, 4);
        this.rightArm.setPos(-5.0F, 2.0F, 0.0F);
        this.leftArm = new TransparentModelRenderer(this, 0, 16).addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4);
