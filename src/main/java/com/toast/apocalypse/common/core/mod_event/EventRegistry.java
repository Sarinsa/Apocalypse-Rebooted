...
public class EventRegistry {
     ...
     * has the given numerical ID and returns it.
     ...
     *
     * @param id               The numerical ID of this event type.
    ...
    public static <T extends AbstractEvent> EventType<T> register( int id, String name, @Nonnull EventType.IEventFactory<T> factory,
        ...
        if( EVENTS.put( id, eventType ) != null ) {
            throw new IllegalArgumentException( "Attempted to register Apocalypse event with duplicate ID: " + id );
        }
        return eventType;
    }
