...
public class EventRegistry {
    ...
    public static final EventType<?> NONE = register(-1, EmptyEvent::new, null, true,
            (serverWorld, currentEvent, player, isFullMoonNight) -> false);
    ...
    private static <T extends AbstractEvent> EventType<T> register(int id, EventType.IEventFactory<T> factory, String startMessage , boolean canBeInterrupted, IStartupPredicate startupPredicate) {
        ...
        EventType<T> eventType = new EventType<>(id, factory, startMessage, canBeInterrupted, startupPredicate);
