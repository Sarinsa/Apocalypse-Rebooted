...
public class ApocalypseConfig {
    ...
    public static final LunarSiegeConfig LUNAR_SIEGE = new LunarSiegeConfig(ConfigManager.getRequired(Apocalypse.MODID), "lunar_siege");
    /** Settings related to acid rain. */
    public static final AcidRainConfig ACID_RAIN = new AcidRainConfig(ConfigManager.getRequired(Apocalypse.MODID), "acid_rain");
