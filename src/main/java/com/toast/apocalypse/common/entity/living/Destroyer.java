    ...
    protected static class DestroyerLookAroundGoal extends Goal {
        ...
        public void tick() {
            if (destroyer.getTarget() == null) {
                ...
                if (!destroyer.attackedBySiegeTarget()
                        && destroyer.isTargetingSpawnPoint
                        && serverPlayer.getRespawnPosition() != null
                        && (serverPlayer.getRespawnDimension().equals(destroyer.level.dimension()))
