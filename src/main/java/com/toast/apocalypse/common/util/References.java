...
public class References {
    ...
    public static final String DIFFICULTY_UPDATED_MESSAGE = "apocalypse.command.set_difficulty.update_message";
    public static final String MAX_DIFFICULTY_UPDATED_MESSAGE = "apocalypse.command.max_difficulty.update_message";
}
